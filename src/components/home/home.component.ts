...
export class HomeComponent implements AfterViewInit {
  ...
  events = [
    {
      ...
      description:
        'Compétition sportive rassemblant les étudiants autour du fair-play et de l’esprit d’équipe.',
    },
    {
      image: 'Activité 2.jpeg',
      title: 'Activité Culturelle',
      description:
        'Une activité mettant en valeur la créativité et les talents artistiques des participants.',
    },
    {
      image: 'kenitra mauri league.jpeg',
      title: 'Kenitra Mauri League',
      description:
        'Tournoi interuniversitaire réunissant les étudiants mauritaniens de Kénitra.',
    },
    {
      image: 'Fête de independance.jpeg',
      title: 'Fête de l’Indépendance',
      description:
        'Célébration nationale marquant l’unité et la culture mauritanienne à l’étranger.',
    },
    {
      image: 'Mcf aisec.jpeg',
      title: 'Mcf AIESEC',
      description:
        'Collaboration entre associations étudiantes pour promouvoir le leadership et l’échange culturel.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Compétition amicale inspirée de la Coupe d’Afrique des Nations entre clubs étudiants.',
    },
    {
      image: 'Eid al fitr 2025.jpeg',
      title: 'Eid Al-Fitr 2025',
      description:
        'Moment de partage et de convivialité pour célébrer la fin du Ramadan entre étudiants.',
    },
    {
      image: 'Soirée excellence 2025.jpeg',
      title: 'Soirée d’Excellence 2025',
      description:
        'Cérémonie honorant les étudiants les plus méritants dans une ambiance festive.',
    },
    {
  ...
  ngAfterViewInit() {
    if (typeof document !== 'undefined') {
      ...
      const images = ['bag-uesmk.jpg', 'uesmk2.jpeg'];
      let index = 0;
  ...
  loadActivites() {
    this.translate.get('home.events.items').subscribe((translations: any[]) => {
      ...
      if (!Array.isArray(translations)) {
        console.warn(
          '⚠️ Traductions des événements non valides :',
          translations,
        );
        return;
      }
